...
public class ItemResponse {
    ...
    @Schema(description = "주 공급사", example = "1")
    private Long supplId;

    @Schema(description = "바코드", example = "1234567890123")
    private String barcode;

    @Schema(description = "케이스 바코드", example = "9876543210987")
    ...
    @Schema(description = "유통기한 사용 여부", example = "Y")
    private String expDateUseYn;

    @Schema(description = "제조일자 사용 여부", example = "Y")
    private String makeDateUseYn;

    @Schema(description = "제조일로부터 유통기한", example = "365")
    private Integer daysFromMakeDate;
    ...
    @Schema(description = "주 로케이션 아이디", example = "400")
    private Long locId;
